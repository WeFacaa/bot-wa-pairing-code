...
const mess = {
   ...
   off: "Sudah Off",
   query: {
       text: "Teks nya mana lho syang?🙄",
       link: "Link nya mana lho syang🙄",
   },
   error: {
   ...
   only: {
       ...
       user: "Maaf Kamu Belum Jadi User Queen Elisa MD Untuk Menjadi User Elisa Silahkan Beli Ke Owner Dengan Cara Ketik .owner",
